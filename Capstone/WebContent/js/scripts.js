...
function populateListings() {
  ...
  function Listing(image, item, size, price) {
    this.image = image;
    this.item = item;
    this.size = size;
    this.price = price;
...
//    var tableData4 = document.createElement("td");
    ...
    var item = document.createTextNode(listingCollection[index].item);
    var size = document.createTextNode(listingCollection[index].size);
...
//    tableData1.setAttribute("padding:0");
    ...
    tableData3.appendChild(item);
    //tableData4.appendChild(size);
...
function populateShowings() {
  ...
  var itemsHeader = document.createTextNode("Items");
  var sizeHeader = document.createTextNode("Size");
  var priceHeader = document.createTextNode("Price");
...
//  var thStyle = document.getElementsByTagName("th")[0];
  ...
  tableHeader1.appendChild(itemsHeader);
  tableHeaderRow.appendChild(tableHeader2);
  tableHeader2.appendChild(sizeHeader);
  tableHeaderRow.appendChild(tableHeader3);
  tableHeader3.appendChild(priceHeader);
  ...
  for (var index = 0; index < checkedListings.length; index++) {
    ...
    var item = document.createTextNode(checkedListings[index].item);
    var size = document.createTextNode(checkedListings[index].size);
    var price = document.createTextNode(checkedListings[index].price);

    tableData2.appendChild(item);
    tableData3.appendChild(size);
